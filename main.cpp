...
{
    void check_recompile(bool should_recompile, int& current_idx, int& selected_idx, bool should_soft_recompile,
    ...
    while(!win.should_close() && !menu.should_quit && fullscreen.open)
    {
        ...
        else
        {
            ...
            if(!taking_screenshot && !hide_ui)
            {
                ...
                metric_manage.check_recompile(should_recompile, current_idx, selected_idx, should_soft_recompile, parent_directories,
